// E2E test suite for GET /api/informational-events endpoint
...
import handler from '../../api/informational-events';
...
const SAMPLE_EVENTS = [
  ...
  },
  {
    ...
    source: 'informational',
    raw_body: '{"type":"CHoCH","symbol":"NQ"}',
    content_type: 'application/json',
  },
];

describe('Informational Events API E2E Tests', () => {
  beforeEach(() => {
    fromCallIndex = 0;
