...
async function main(): Promise<void> {
  ...
  if (!fromDate || !toDate) {
    console.error('Usage: npm run backtest -- --from <date> --to <date> [--symbol ES] [--verbose] [--sl-buffer 8] [--quantity 1]');
  ...
  console.log(`Running backtest for ${symbol} from ${fromDate} to ${toDate}...`);
