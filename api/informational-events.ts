...
import type { InformationalEventsResponse, PaginationMeta } from '../src/types';
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  try {
    ...
    const response: InformationalEventsResponse = { success: true, data: data ?? [], pagination };
